...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepindoadik.pages.dev/v/${file.filecode}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepindoadik.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepindoadik.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
